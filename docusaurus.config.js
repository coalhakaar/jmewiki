...
const config = {
  ...
  organizationName: 'coalhakaar', // Usually your GitHub org/user name.
  projectName: 'jmewiki', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      image: 'img/jmewiki-social-card.png',
      navbar: {
        title: 'JME Wiki',
        logo: {
          alt: 'JME Wiki Logo',
